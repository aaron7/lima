...
public class Web {
     ...
     * @param ip The router IP the job is being run upon.
     * @param timestamp The timestamp of the file the job is running.
     * @param numOfJobs The number of sub-jobs that run during this job.
     */
     ...
     * @param ip The router IP the job is being run upon.
     * @param timestamp The timestamp of the file that the job is running.
     * @param allComplete A boolean indicator of if all sub-jobs have finished.
     */
     ...
     * @param args Parameters to be added to the end of the query URL.
     */
