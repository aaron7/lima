...
/**
 * Threat synchroniser synchronises the threats from HBase to PGSQL with no intermediate operation taking place.
 */
class ThreatSynchroniser implements IDataSynchroniser {
     ...
     *
     * @param routerID
     *         The router ID we are to synchronise threats for (its IP address, typically)
     */
