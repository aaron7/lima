...
public class HBaseConnectionDetails {
    ...
    /**
     * Construct a new HBaseConnectionDetails with the information about connecting to HBase.
     *
     * @param host
     *         Hostname of the HBase server.
     * @param port
     *         Port number on which HBase is listening.
     */
