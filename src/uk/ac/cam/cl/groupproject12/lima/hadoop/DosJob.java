...
public class DosJob extends JobBase {
    ...
    /**
     * The first map job takes text and produces a FlowRecord if the particular flow is suspicious. The keys are based on a
     * minute-based timestamp, the destination address and the source address.
     *
     * @see FlowRecord
     */
    ...
    /**
     * The first reduce job combines all flows with the same key and aggregates the appropriate fields. It outputs an
     * instance of DoSAttack with the same key.
     */
    ...
    /**
     * The second map job creates a key that represents the minute timestamp and the destination address of the attack.
     */
    ...
    /**
     * The second reduce job collects the data for the same key. It only outputs if the whole DosAttack is determined to be
     * significant, i.e. that the data is not noise.
     */
    ...
    public static class DoSAttack extends AutoWritable {
         ...
         * @param bytes
         *         Number of bytes in the attack.
         * @param flowCount
         *         Number of flows in the attack.
         * @param srcIPCount
         *         Number of sources participating in the attack.
         */
    ...
    /**
     * This method takes in a DoSAttack and determines whether it is significant, i.e. whether it is just noise data, or
     * whether it is an actual attack.  This is based on the size of the flow, the number of packets transmitted, and so
     * on.
     *
     * @param res
     *         A DoS attack object.
     ...
     *
     * @param routerIp
     *         IP of the router from which this logfile excerpt was split.
     * @param timestamp
