...
public class FlowRecord extends AutoWritable {
    ...
    /**
     * Interprets the value of the bytes field. This value can be an integer number, however it can also have a suffix of
     * 'M' to indicate megabytes.
     *
     * @param string
     *         Raw data from the bytes field.
     *
     ...
     *
     * @param input
     *         Item to read FlowRecord content from.
     *
     * @return New FlowRecord.
     */
