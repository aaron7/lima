 ...
 * <p/>
 * The threat was processed at timeProcessed (in UNIX time) in the logged data for the router identified by routerId.
 * The threat consists of flowCount different flows, the earliest starting at startTime, the latest ending at endTime.
 * flowDataTotal gives the total number of bytes carried by all of the flows considered as part of this attack.<br />
 * <p/>
 * If the threat targets a single IP it will be stored in destIP; if the threat originates from a single IP it will be
 * stored in srcIP.
 */
public class Threat extends AutoWritable {
     ...
     *
     * @param timeProcessed
     *         The time the threat was processed.
     * @param routerId
     *         The IP address of the router the threat was logged upon.
     * @param type
     *         The type of the event from the EventType enumeration.
     * @param startTime
     *         The time of the first flow that was part of this threat.
     *
     * @see IP
     * @see EventType
     */
     ...
     *         The time of the first flow that was part of this threat.
     * @param endTime
     *         The time of the last flow detected to be part of this threat.
     * @param srcIP
     *         The single source IP involved in this threat (if applicable)
     * @param destIP
     *         The single destination IP involved in this threat (if applicable)
     * @param flowCount
     *         The number of flows relating to this threat.
     * @param packetCount
     *         The number of packets sent in this threat.
     * @param flowDataTotal
     *         The total amount of data to be transferred during this threat.
     *
     * @see EventType
     * @see IP
     */
